...
function showLoader() {
  ...
  loaderTag.src =
    "https://icons8.com/preloaders/preloaders/285/Moving%20blocks.gif";
...
function showIntroCard() {
  ...
  card.animate(
    ...
    { duration: 0x190, iterations: 0x1, easing: "linear" }
  );
  ...
  const headTagText = document.createTextNode("Happy Birthday");
  ...
  const headTag2Text = document.createTextNode("Wanna Play Music??");
  ...
  button.innerText = "Play Video with Music";
  ...
  button.setAttribute("onclick", "hideIntroCard(true)");
  const button2 = document.createElement("button");
  button2.innerText = "Play Video Without Music";
  button2.style.outline = "none";
  button2.style.color = "white";
  button2.style.border = "1px solid white";
  button2.style.backgroundColor = "transparent";
  button2.style.padding = "0.5em 2em";
  button2.style.marginTop = 0xe + "px";
  button2.style.borderRadius = 0x5 + "px";
  para3.appendChild(button2);
  button2.setAttribute("onclick", "hideIntroCard(false)");
...
function hideIntroCard(e) {
  if (e) {
    play();
    setTimeout(hideLoadOne, 5000);
  }
